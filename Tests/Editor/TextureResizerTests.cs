...
namespace dev.limitex.avatar.compressor.tests
{
    ...
    public class TextureResizerTests
    {
        ...
        {
            var result = _resizer.CalculateNewDimensions(512, 512, 1);
        ...
        {
            var result = _resizer.CalculateNewDimensions(512, 512, 2);
        ...
        {
            var result = _resizer.CalculateNewDimensions(1024, 1024, 4);
            Assert.AreEqual(256, result.x);
            Assert.AreEqual(256, result.y);
        }
        ...
        public void CalculateNewDimensions_RespectsMinResolution()
        {
            ...
            var result = _resizer.CalculateNewDimensions(128, 128, 8);
        ...
        public void CalculateNewDimensions_RespectsMaxResolution()
        {
            ...
            var result = _resizer.CalculateNewDimensions(4096, 4096, 1);
        ...
        {
            var result = _resizer.CalculateNewDimensions(1024, 512, 2);
            Assert.AreEqual(512, result.x);
            Assert.AreEqual(256, result.y);
        }
        ...
        public void CalculateNewDimensions_ForcePowerOfTwo_ReturnsPowerOfTwo()
        {
            ...
            var result = _resizer.CalculateNewDimensions(300, 300, 2);
        ...
        {
            var resizerNoPow2 = new TextureResizer(32, 2048, false);
        ...
        {
            var result = _resizer.CalculateNewDimensions(16, 16, 1);
            Assert.AreEqual(32, result.x);
            Assert.AreEqual(32, result.y);
        }
        ...
        public void CalculateNewDimensions_LargeDivisor_ClampsToMin()
        {
            ...
            var result = _resizer.CalculateNewDimensions(256, 256, 16);
            Assert.AreEqual(32, result.x);
            Assert.AreEqual(32, result.y);
        }
        ...
        public void CalculateNewDimensions_AsymmetricClamping_Works()
        {
            ...
            var result = _resizer.CalculateNewDimensions(4096, 512, 1);
            Assert.AreEqual(2048, result.x);
            Assert.AreEqual(512, result.y);
        }
        ...
        {
            var customResizer = new TextureResizer(64, 512, true);
        ...
        public void CalculateNewDimensions_NonPowerOfTwoSource_HandlesCorrectly()
        {
            ...
            var result = _resizer.CalculateNewDimensions(1000, 1000, 2);
        ...
        {
            var result = _resizer.CalculateNewDimensions(256, 1024, 2);
        ...
        {
            var result = _resizer.CalculateNewDimensions(2048, 64, 1);
            Assert.AreEqual(2048, result.x);
        ...
        public void CalculateNewDimensions_PowerOfTwoMaxClamp_HandlesCorrectly()
        {
            ...
            var customResizer = new TextureResizer(32, 300, true);
            var result = customResizer.CalculateNewDimensions(1024, 1024, 1);
        ...
        public void CalculateNewDimensions_AllPowerOfTwoDivisors_ReturnPowerOfTwo()
        {
            ...
            {
                var result = _resizer.CalculateNewDimensions(1024, 1024, div);
        ...
        {
            var result = _resizer.CalculateNewDimensions(32, 32, 1);
            Assert.AreEqual(32, result.x);
            Assert.AreEqual(32, result.y);
        }
        ...
        {
            var result = _resizer.CalculateNewDimensions(2048, 2048, 1);
            Assert.AreEqual(2048, result.x);
            Assert.AreEqual(2048, result.y);
        }
        ...
        {
            var result = _resizer.CalculateNewDimensions(64, 64, 4);
            // 64/4=16, min is 32
            Assert.AreEqual(32, result.x);
            Assert.AreEqual(32, result.y);
        }
        ...
        {
            var result = _resizer.CalculateNewDimensions(2049, 2049, 1);
            Assert.AreEqual(2048, result.x);
            Assert.AreEqual(2048, result.y);
        }
